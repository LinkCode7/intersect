...
void TestPerformance::_testAccuracy(std::map<std::string, std::set<std::string>*>& mapLine2Links, const std::string& strLine1,
...
std::set<std::string>* TestPerformance::_getRelations(std::map<std::string, std::set<std::string>*>& mapLine2Links,
